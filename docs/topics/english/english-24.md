...
> 맞습니다, 그래서 제 쪽 이야기입니다. 둘이요. 첫째, 모두가 미뤄온 정산 재설계요. 설계를 맡아주시길 바라고, 엔지니어 둘과 한 분기를 제가 확보하겠습니다. 둘째, 다음 달 CTO에게 첫 아키텍처 발표를 할 때 감사를 통과시킨 정합성 검증 시스템이 당신 것이었다고 말하겠습니다. 실제로 그랬으니까요.
