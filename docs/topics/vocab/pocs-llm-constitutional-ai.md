| Expression | 뜻 · 쓰이는 자리 |
|---|---|
| critique and revise | 스스로 비판하고 수정하다 · 모델이 자기 출력을 원칙에 비추어 점검하고 고치는 과정 · "critique and revise its own outputs" |
| reduce reliance on | ~에 대한 의존을 줄이다 · 사람이 일일이 라벨링하지 않아도 되게 만든다는 뜻 · "reducing reliance on human labels" |
