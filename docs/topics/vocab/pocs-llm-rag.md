...
| bottleneck | 병목 · 성능을 가장 크게 제약하는 지점을 가리킬 때. "showing the bottleneck is upstream of the model" |
...
| failure mode | 실패 양상·고장 유형 · 시스템이 잘못될 때 나타나는 전형적인 방식. "moves the failure mode from hallucination to retrieval quality" |
