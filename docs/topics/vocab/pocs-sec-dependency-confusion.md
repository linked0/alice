| Expression | 뜻 · 쓰이는 자리 |
|---|---|
| name-resolution mismatch | 이름 해석(매칭)이 어긋나는 것 · "reproduces the name-resolution mismatch in a sandbox" |
| supply-chain class | 공급망 공격 유형 · "a supply-chain class that hit major companies" |
