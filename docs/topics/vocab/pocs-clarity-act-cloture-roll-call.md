| Expression | 뜻 · 쓰이는 자리 |
|---|---|
| cloture | 토론 종결 절차 · 미국 상원에서 토론을 끝내고 표결로 넘기는 절차. "cloture failed on 2026-09-15; 60 needed" |
| fall short | 목표·기준에 못 미치다, 부족하다 · 표결이 정족수에 못 미쳤을 때. "fell about eleven short of the sixty needed" |
| whip count | 원내 총무의 찬반 표 집계 · 표결 전 예상 득표수 파악. "the whip count was optimistic" |
| half-life | 사실·정보의 유효 기간 · 시간이 지나도 여전히 유효한지 아닌지 비유. "different facts with different half-lives" |
| walk (away) | 협상·합의를 저버리고 떠나다 · 협상팀이 완전히 등을 돌렸다는 뜻. "the negotiators walked" |
| divestment | 이해충돌 회피를 위한 자산 매각 · 공직자가 보유 자산을 처분하는 절차. "mandatory divestment within 180 days" |
| durable | 법·제도가 오래 지속될 수 있는, 견고한 · 법 없이는 규정이 흔들린다는 맥락. "won't be durable without a law underpinning them" |
