...
const RAIL_SCRIPT = String.raw`
  ...
  const paintPills = () => { for (const p of pills) p.classList.toggle('on', !!railSection && p.dataset.sec === railSection); };
  ...
  document.addEventListener('rail-all-change', applyFilter); // red badge clicked (_progress.js)
  for (const p of pills) {
    p.addEventListener('click', (e) => {
      if (document.body.classList.contains('rail-all')) return;            // badge All: every section already shows
